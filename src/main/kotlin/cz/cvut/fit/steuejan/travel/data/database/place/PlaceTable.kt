...
object PlaceTable : IntIdTable("places") {
    ...
    val googlePlaceId = varchar("google_place_id", DatabaseConfig.TEXT_MAX_LENGTH).nullable()
    val address = varchar("address", DatabaseConfig.TEXT_MAX_LENGTH).nullable()
    val phone = varchar("phone", DatabaseConfig.PHONE_LENGTH).nullable()
    val email = varchar("email", DatabaseConfig.EMAIL_LENGTH).nullable()
    val website = varchar("website", DatabaseConfig.TEXT_MAX_LENGTH).nullable()
    val wikiBrief = varchar("wiki_brief", DatabaseConfig.WIKI_MAX_LENGTH).nullable()
